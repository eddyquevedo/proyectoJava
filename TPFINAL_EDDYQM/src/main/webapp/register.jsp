    ...
    <main>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    <div class="container d-flex">
                        <h1 style="color: green; margin-top: auto; margin-bottom: 50px;">Registrarse</h1>
                    </div>
                    <form action="register" method="post">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <div class="d-grid">
                                    <input type="submit" class="btn btn-lg btn-form rounded-top btn-secondary" value="Registrarse">
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <form class="container" action="login.jsp">
            <article class="text-center mt-4">
                <input type="submit" class="btn btn-lg btn-form rounded-top btn-primary" value="Iniciar Sesión">
            </article>
        </form>
