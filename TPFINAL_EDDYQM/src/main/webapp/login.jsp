...
<section class="container" id="form-orador">
    <div class="row justify-content-center">
        ...
        <div class="container d-flex">
                        <h1 style="color: blue; margin-top: auto; margin-bottom: 50px;">Iniciar Sesión</h1>
                    </div>
            <form action="login" method="post">
                ...
                <div class="row">
                    <div class="col mb-3">
                        <div class="d-grid">
                            <button type="submit" class="btn  btn-lg btn-form rounded-top btn-primary">Iniciar Sesión</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <form class="container" action="register.jsp">
                <article class="text-center mt-3">
                    <input type="submit" class="btn btn-lg btn-form rounded-top btn-success" value="Registrarse">
                </article>
            </form>
